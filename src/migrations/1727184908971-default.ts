...
export class Default1727184908971 implements MigrationInterface {
    name = 'Default1727184908971'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "imagen" ("id" number GENERATED BY DEFAULT AS IDENTITY, "name" varchar2(255) NOT NULL, "base64" clob NOT NULL, "usuario" number, "trending" number, "usuario_id" number, "trending_id" number, CONSTRAINT "REL_ea228b85fd2cc829837a2ac4bf" UNIQUE ("usuario_id"), CONSTRAINT "REL_3ed15bb10eadfaadffd6bd22e4" UNIQUE ("trending_id"), CONSTRAINT "PK_c9838d52bca36e9244bcb95bee6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "imagen" ADD CONSTRAINT "FK_3ed15bb10eadfaadffd6bd22e42" FOREIGN KEY ("trending_id") REFERENCES "trending" ("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "imagen" DROP CONSTRAINT "FK_3ed15bb10eadfaadffd6bd22e42"`);
