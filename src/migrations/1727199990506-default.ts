...
export class Default1727199990506 implements MigrationInterface {
    name = 'Default1727199990506'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trending_imagem" ("trending_id" number NOT NULL, "imagem_id" number NOT NULL, CONSTRAINT "PK_246beaf37e4b61b01519b814dd3" PRIMARY KEY ("trending_id", "imagem_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_095d3ea5c4426a83665952d361" ON "trending_imagem" ("trending_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_45c3d5414a31134ef83f6b3d6f" ON "trending_imagem" ("imagem_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "trending_imagem" ADD CONSTRAINT "FK_095d3ea5c4426a83665952d3616" FOREIGN KEY ("trending_id") REFERENCES "trending" ("id") ON DELETE CASCADE`);
        await queryRunner.query(`ALTER TABLE "trending_imagem" ADD CONSTRAINT "FK_45c3d5414a31134ef83f6b3d6f9" FOREIGN KEY ("imagem_id") REFERENCES "imagen" ("id")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "trending_imagem" DROP CONSTRAINT "FK_45c3d5414a31134ef83f6b3d6f9"`);
        await queryRunner.query(`ALTER TABLE "trending_imagem" DROP CONSTRAINT "FK_095d3ea5c4426a83665952d3616"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_45c3d5414a31134ef83f6b3d6f"`);
        await queryRunner.query(`DROP INDEX "IDX_095d3ea5c4426a83665952d361"`);
