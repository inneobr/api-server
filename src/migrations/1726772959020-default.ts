...
export class Default1726772959020 implements MigrationInterface {
    name = 'Default1726772959020'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" number GENERATED BY DEFAULT AS IDENTITY, "uuid" varchar2(255) NOT NULL, "name" varchar2(255) NOT NULL, "email" varchar2(255) NOT NULL, "biografia" varchar2(255), "base64" clob, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
