...
export class Default1726863694785 implements MigrationInterface {
    name = 'Default1726863694785'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "imagen" ("id" number GENERATED BY DEFAULT AS IDENTITY, "name" varchar2(255) NOT NULL, "base64" clob NOT NULL, "profileId" number, CONSTRAINT "REL_04a03b7c9ef376f866fb6da03b" UNIQUE ("profileId"), CONSTRAINT "PK_c9838d52bca36e9244bcb95bee6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "profile" ("id" number GENERATED BY DEFAULT AS IDENTITY, "name" varchar2(100) NOT NULL, "email" varchar2(100) NOT NULL, "biography" varchar2(100), "usuarioId" number, CONSTRAINT "REL_15aa9e08b5c9d0e78e8d432994" UNIQUE ("usuarioId"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
