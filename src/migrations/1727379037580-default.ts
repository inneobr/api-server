...
export class Default1727379037580 implements MigrationInterface {
    name = 'Default1727379037580'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "imagen" ("id" number GENERATED BY DEFAULT AS IDENTITY, "name" varchar2(255) NOT NULL, "imagem" clob NOT NULL, "usuario" number, "trending" number, "usuario_id" number, CONSTRAINT "REL_ea228b85fd2cc829837a2ac4bf" UNIQUE ("usuario_id"), CONSTRAINT "PK_c9838d52bca36e9244bcb95bee6" PRIMARY KEY ("id"))`);
